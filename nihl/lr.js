...
let _hloss      = _HL.NORMAL;   // Current level of hearing loss
...
// An array holding unplayed sentence indexes to avoid repeats
const _playlist = [];
...
agPresetMap.set(_HL.MILD,     {'b125':20,  'b250':15,  'b500':10, 'b1000':15,  'b2000':20,  'b4000':120,  'b8000':20});
...
function setLevelHL(anc) {
    ...
    switch (id) {
        ...
        case 'id_mild_hl':
            ...
            title.innerHTML = "Noise-Induced Hearing Loss <br><span>→ 120 dB HL at 4000 Hz</span>";
            audiog.src = "noise-induced.png";
