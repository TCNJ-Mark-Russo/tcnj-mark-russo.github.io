...
},
{
  "id": "p-395",
  "level": "2",
  "url": "section-c1-if-statements.html#p-395",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-398",
  "level": "2",
  "url": "section-c1-if-statements.html#p-398",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "5.1.1",
  "title": "",
  "body": "  Our game has two more circles that must be tested and points awared. Finish the above method by adding two more if-statements that award points when the dart lands in the blue and yellow circular bands. Make sure that each condition is written in a way that ensures it is exclusive of all other conditions.     public static void awardPoints(double x1, double y1) { \/\/ Circle parameters double xc = 300.0, yc = 300.0; \/\/ Compute distance double dist = Math.sqrt(Math.pow(x1 - xc, 2) + Math.pow(y1 - yc, 2)); \/\/ Branch depending on distance from center if (dist < 60) { \/\/ In center red circle. Add 4 points. total = total + 4; } if (dist >= 60 && dist < 120) { \/\/ In green circle. Add 3 points. total = total + 3; } \/\/ Remaining test if (dist >= 120 && dist < 180) { \/\/ In blue circle. Add 2 points. total = total + 2; } if (dist >= 180 && dist < 240) { \/\/ In yellow circle. Add 1 point. total = total + 1; } }    "
},
{
...
},
{
  ...
  "body": " break and continue   Two additional statements are available to modify the flow of a while-statement and other iteration statements in Java. These two statements are break and continue .  The break statement immediately breaks out of a while-statement, regardless of the value of the conditional expression, and continues execution immediately after the while-statement. The continue statement immediately stops execution of a while-statement code block, cutting it short, but it returns to the conditional expression and evaluates it to see if another iteration should be performed.    break Statement  A break statement is useful when you are iterating using a while-statement or other iteration statement and you determine that the entire iteration can be terminated, so flow can immediately leave the while-statement. There is no need to complete the statement code block and no need to test the conditional expression.    continue Statement  A continue statement also jumps out of a while-statement code block, similar to break . It differs from break in the sense that it does not cause program flow to leave a while-statement altogether. Instead, it returns immediately to the conditional expression to test if another iteration should be performed.    Guess a Number  Let's write a simple game that chooses a random integer at random in the range [0, 9] and gives the player three chances to guess the right number. This game is implemented in and depends heavily on the break and continue statements to work properly.   NumberGuess.java   \/\/ NumberGuess.java import java.util.Scanner; \/\/ Import helper classes import java.util.Random; public class NumberGuess { public static void main(String[] args) { \/\/ Instantiate a Scanner to read from the terminal Scanner scnr = new Scanner(System.in); \/\/ Instantiate a random number generator Random rnd = new Random(); \/\/ Pick a random number to be guessed int answer = rnd.nextInt(10); int count = 0; \/\/ Counter while (true) { \/\/ Keep going count++; \/\/ Increment count if (count > 3) { \/\/ Max three guesses. System.out.println(\"No more guesses.\"); System.out.println(\"The correct number was \" + answer); break; } \/\/ Prompt user and read response. System.out.print(\"Guess a number in [0, 9]: \"); int resp = scnr.nextInt(); if (resp < answer) { \/\/ Check value System.out.println(\"Too low.\"); continue; \/\/ Try again } else if (resp > answer) { System.out.println(\"Too high.\"); continue; \/\/ Try again } else { \/\/ Must be the right guess! System.out.println(\"Correct. You win!\"); break; } } } }    The NumberGuess class in starts by importing both the Scanner and Random helper classes from java.util . The main(…) method instantiates a new Random object and a Scanner object reading from System.in. It picks a random integer in [0, 9] to be guessed, initializes a counter variable and then enters a while-state with the condition true , which means that the while-statement will continue indefinitely, at least until a break statement causes the while-statement to exit. The count is incremented each time the whiel-statement is entered and then an if-statement tests to see of the player is out of guesses. If so, the player is informed that they are out of guesses and a break exits the loop.  If the player has more guesses, the player is prompted for a new guess, which is read and compared to the answer. When the guess does not match the answer, the user is given a hint and the continue statement immediately returns to and tests the while-statement condition, and if true , the while-statement block re-enters the code block.  Here are several examples of playing the NumberGuess.java game program.   javac NumberGuess.java java NumberGuess  Guess a number in [0, 9]: 5 Too high. Guess a number in [0, 9]: 4 Too high. Guess a number in [0, 9]: 2 Too high. No more chances. The correct number was 1    java NumberGuess  Guess a number in [0, 9]: 5 Too high. Guess a number in [0, 9]: 3 Too high. Guess a number in [0, 9]: 2 Correct. You win!     The break and continue statements provide an enhanced ability to customize the standard behavior of the while-statement for special-purpose computing and fine control of control flow.   "
},
{
...
},
{
  "id": "p-459",
  "level": "2",
  "url": "section-c1-collection-classes.html#p-459",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-461",
  "level": "2",
  "url": "section-c1-collection-classes.html#p-461",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-484",
  "level": "2",
  "url": "section-c1-block-scope.html#p-484",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "block "
},
{
  "id": "p-485",
  "level": "2",
  "url": "section-c1-block-scope.html#p-485",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "block scope "
...
},
{
  "id": "p-494",
  "level": "2",
  "url": "section-c2-for-statements.html#p-494",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "for-statement "
...
},
{
  "id": "p-511",
  "level": "2",
  "url": "section-c2-enhanced-for-statements.html#p-511",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "for-each "
...
},
{
  "id": "p-523",
  "level": "2",
  "url": "section-c2-switch-statements.html#p-523",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-527",
  "level": "2",
  "url": "section-c2-switch-statements.html#p-527",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "only "
},
{
  "id": "p-528",
  "level": "2",
  "url": "section-c2-switch-statements.html#p-528",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "not "
...
},
{
  "id": "p-537",
  "level": "2",
  "url": "section-c2-ternary-operator.html#p-537",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-542",
  "level": "2",
  "url": "section-c2-comparisons.html#p-542",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-560",
  "level": "2",
  "url": "section-c2-comparisons.html#p-560",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-566",
  "level": "2",
  "url": "section-ar-creating.html#p-566",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "array "
...
},
{
  "id": "p-587",
  "level": "2",
  "url": "section-ar-creating.html#p-587",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "new "
...
},
{
  "id": "p-617",
  "level": "2",
  "url": "section-ar-multi.html#p-617",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "ragged arrays "
...
},
{
  "id": "p-640",
  "level": "2",
  "url": "section-cl-class-v-instance.html#p-640",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "object scope "
},
{
  "id": "p-641",
  "level": "2",
  "url": "section-cl-class-v-instance.html#p-641",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "encapsulate "
...
},
{
  "id": "p-642",
  "level": "2",
  "url": "section-cl-constructors.html#p-642",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "constructor "
},
{
  "id": "p-643",
  "level": "2",
  "url": "section-cl-constructors.html#p-643",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "constructor "
...
},
{
  "id": "p-650",
  "level": "2",
  "url": "section-cl-constructors.html#p-650",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "driver "
...
},
{
  "id": "p-654",
  "level": "2",
  "url": "section-cl-methods.html#p-654",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-663",
  "level": "2",
  "url": "section-cl-methods.html#p-663",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-664",
  "level": "2",
  "url": "section-cl-methods.html#p-664",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-691",
  "level": "2",
  "url": "section-cl-anonymous-objects.html#p-691",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "anonymous "
...
},
{
  "id": "p-697",
  "level": "2",
  "url": "section-cl-multi-file-programs.html#p-697",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Driver Class "
...
},
{
  "id": "p-701",
  "level": "2",
  "url": "section-cl-packages.html#p-701",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "package "
...
},
{
  "id": "p-715",
  "level": "2",
  "url": "section-cl-packages.html#p-715",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "namespace "
...
},
{
  "id": "p-722",
  "level": "2",
  "url": "section-in-dp-design.html#p-722",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Inheritance "
...
},
{
  "id": "p-724",
  "level": "2",
  "url": "section-in-basics.html#p-724",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-729",
  "level": "2",
  "url": "section-in-basics.html#p-729",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "extends Shape "
...
},
{
  "id": "p-738",
  "level": "2",
  "url": "section-in-overriding.html#p-738",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "overrides "
...
},
{
  "id": "p-753",
  "level": "2",
  "url": "section-in-polymorph.html#p-753",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-754",
  "level": "2",
  "url": "section-in-polymorph.html#p-754",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "subtype polymorphism "
...
},
{
  "id": "p-765",
  "level": "2",
  "url": "section-in-polymorph.html#p-765",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Derived "
},
{
  "id": "p-767",
  "level": "2",
  "url": "section-in-polymorph.html#p-767",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "instanceof "
...
},
{
  "id": "p-775",
  "level": "2",
  "url": "section-in-object-class.html#p-775",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Object "
...
},
{
  "id": "p-783",
  "level": "2",
  "url": "section-in-abstract-class.html#p-783",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "abstract "
},
{
  "id": "p-784",
  "level": "2",
  "url": "section-in-abstract-class.html#p-784",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "abstract "
...
},
{
  "id": "p-795",
  "level": "2",
  "url": "section-if-comparable.html#p-795",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-826",
  "level": "2",
  "url": "section-if-polymorph.html#p-826",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-827",
  "level": "2",
  "url": "section-if-polymorph.html#p-827",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-840",
  "level": "2",
  "url": "section-ex-errors.html#p-840",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-841",
  "level": "2",
  "url": "section-ex-errors.html#p-841",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "call stack "
},
{
  "id": "p-842",
  "level": "2",
  "url": "section-ex-errors.html#p-842",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "caught "
...
},
{
  "id": "p-845",
  "level": "2",
  "url": "section-ex-classes.html#p-845",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-850",
  "level": "2",
  "url": "section-ex-catching.html#p-850",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-858",
  "level": "2",
  "url": "section-ex-catching.html#p-858",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-864",
  "level": "2",
  "url": "section-ex-catching.html#p-864",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-868",
  "level": "2",
  "url": "section-ex-reading-files.html#p-868",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "file extension "
},
{
  "id": "p-869",
  "level": "2",
  "url": "section-ex-reading-files.html#p-869",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-884",
  "level": "2",
  "url": "section-try-with-resources.html#p-884",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-885",
  "level": "2",
  "url": "section-try-with-resources.html#p-885",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "AutoClosable "
...
},
{
  "id": "p-906",
  "level": "2",
  "url": "section-re-thinking.html#p-906",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "base case "
},
{
  "id": "p-907",
  "level": "2",
  "url": "section-re-thinking.html#p-907",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "recursive case "
...
},
{
  "id": "p-914",
  "level": "2",
  "url": "section-re-call-stack.html#p-914",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-932",
  "level": "2",
  "url": "section-re-characterising.html#p-932",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-934",
  "level": "2",
  "url": "section-re-characterising.html#p-934",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-945",
  "level": "2",
  "url": "section-re-characterising.html#p-945",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-951",
  "level": "2",
  "url": "section-re-graphics.html#p-951",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "multiple recursion "
...
},
{
  "id": "p-957",
  "level": "2",
  "url": "section-al-complexity.html#p-957",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-958",
  "level": "2",
  "url": "section-al-complexity.html#p-958",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-967",
  "level": "2",
  "url": "section-al-sequential-search.html#p-967",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-969",
  "level": "2",
  "url": "section-al-sequential-search.html#p-969",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Comparison "
...
},
{
  "id": "p-975",
  "level": "2",
  "url": "section-al-binary-search.html#p-975",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-977",
  "level": "2",
  "url": "section-al-binary-search.html#p-977",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-983",
  "level": "2",
  "url": "section-al-selection-sort.html#p-983",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-985",
  "level": "2",
  "url": "section-al-selection-sort.html#p-985",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "merge sort "
...
},
{
  "id": "p-989",
  "level": "2",
  "url": "section-al-insertion-sort.html#p-989",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-995",
  "level": "2",
  "url": "section-al-merge-sort.html#p-995",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1005",
  "level": "2",
  "url": "section-dp-doodlepad.html#p-1005",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Java ARchive "
...
},
{
  "id": "p-1024",
  "level": "2",
  "url": "section-dp-shapes.html#p-1024",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "nullary "
